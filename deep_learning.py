...
# SPECIFICATION: Uses deep learning to identify images of clothing.
...
for hidden in n_hidden:                          #looking or the best parameters w.r.t the number of hidden layers
    for neuron in n_neurons:                      #looking or the best parameters w.r.t the number of neurons
        for rate in l_rate:                  #looking or the best parameters w.r.t the learning rate
            ...
            model = build_model(1, hidden, neuron, rate)
            ...
            if acc > highestAccuracy:
                ...
                print("Parameters: " + "Number of Hidden Layers: " + str(hidden) + ",number of neurons: " + str(neuron) + ",learning rate: " + str(rate))
                print()
